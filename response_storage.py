...
section_one_questions = [
    "Присутствует ли болевой синдром при попытке пошевелить пальцем?",
    "Вы падали или ударялись рукой?",
    "Возможно ли свободное движение пальцем?",
    "Способна ли кисть выоплнять функции захвата//удерживания объектов?",
    "Отекла ли травмированная область,посинел ли палец?",
    "Он онемел?",
